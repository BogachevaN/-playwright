...
export class ContactsStatusesPage extends BasePage {
    readonly url: string
    ...
    constructor(page: Page) {
        super(page)
        this.url = `${envVars.baseUrl}/admin/settings/contacts/statuses`
        this.addNewStatusBtn = page.getByRole('button', { name: 'Add new status' })
        this.statusCreatedMsg = page.getByText('The contact status has been successfully created')
        this.statusDeletedMsg = page.getByText('The contact status has been successfully deleted')
        this.statusUpdatedMsg = page.getByText('The contact status has been successfully updated')
    }
