...
export class TicketsCustomFieldsPage extends BasePage {
    readonly url: string
    readonly noCustomFieldsText: Locator
    ...
    constructor(page: Page) {
        super(page)
        this.url = `${envVars.baseUrl}/admin/settings/tickets/custom-fields`
        this.noCustomFieldsText = page.getByText('You have no custom fields yet')
